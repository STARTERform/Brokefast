...
(function() {
var version = "0.0.1";
console.log("Made with milkcan GL v" + version);
var FF = {
...
Program.prototype.setUniform = function(n, t, v) {
    ...
    if(gl[t]) {
        try {
            return gl[t](gl.getUniformLocation(this.program, n), v);
        }
        catch(e) {
...
var applyGL = function(id) {
    ...
    FF.width = c.width;
    FF.height = c.height;
    FF.gl = JG.can.getContext("webgl2");
    console.log("Attempting to initiate WebGL2 context ...");
    if(!FF.gl) {
        FF.gl = FF.can.getContext("experimental-webgl2");
    ...
    if(!FF.gl) {
        FF.gl = FF.can.getContext("experimental-webgl");
...
var createCanvas = function(w, h) {
    ...
    throw new Error("There can only be one active MCGL canvas");
};
var use = function(p) {
